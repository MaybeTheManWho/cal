...
const CalendarPage = () => {
  const { events, addEvent, updateEvent, deleteEvent, getEventsByDate } = useContext(CalendarContext);
                  ...
                  <div className="h-full flex flex-col">
                    ...
                    <div className="flex-1 overflow-y-auto scrollbar-thin">
                      {dateEvents.slice(0, 3).map((event, idx) => (
                        <div
                          key={event.id}
                          className="bg-primary bg-opacity-10 rounded px-1.5 py-0.5 mb-1 text-xs truncate text-primary"
                        >
                          {event.title}
                        </div>
                      ))}
                ...
                .map(event => (
                  ...
                  >
                    <div className="flex items-start">
                      <div className="w-12 h-12 rounded-lg bg-primary bg-opacity-20 flex items-center justify-center mr-3">
                        <img 
